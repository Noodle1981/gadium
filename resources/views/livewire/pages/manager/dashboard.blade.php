...
<div>
    ...
    <div class="space-y-8">
        ...
        <div class="bg-white rounded-3xl border border-gray-200 shadow-sm p-8 flex flex-col md:flex-row items-center justify-between">
            ...
            <a href="{{ route('viewer.dashboard') }}" class="inline-flex items-center px-6 py-3 bg-gray-900 text-white font-bold rounded-2xl hover:bg-gray-800 transition-colors shadow-lg">
                Ir a Inteligencia
