...
new class extends Component {
    ...
    {
        $historyRoute = 'admin.staff-satisfaction.index';
        if (auth()->user()->hasRole('Manager')) {
            $historyRoute = 'manager.staff-satisfaction.index';
        } elseif (auth()->user()->hasRole('Gestor de Satisfacción Personal')) {
            $historyRoute = 'staff-satisfaction.encuesta';
        }
