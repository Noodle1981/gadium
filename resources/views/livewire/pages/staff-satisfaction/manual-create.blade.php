...
<div>
    ...
    <div class="py-10">
        ...
        <div class="m-4 flex justify-between">
            ...
            <button wire:click="save" class="inline-flex items-center px-6 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-orange-600 hover:bg-orange-700 focus:outline-none">
                Guardar Todo
            </button>
        </div>
    </div>
