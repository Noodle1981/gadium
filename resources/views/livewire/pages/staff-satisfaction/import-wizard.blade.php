        ...
        @if($step === 4)
             <div class="text-center space-y-6">
                ...
                <div class="mt-6 flex justify-center space-x-4">
                    ...
                    <a href="{{ route('app.staff-satisfaction.surveys') }}" class="inline-flex items-center px-6 py-2 border border-transparent text-sm font-bold rounded-xl text-white bg-orange-600 hover:bg-orange-700 shadow-md transition-all hover:scale-105">
                        Ir al Historial
                    </a>
                </div>
            </div>
