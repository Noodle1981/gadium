...
new class extends Component {
    ...
    public $type = 'purchase_detail'; // Changed type
    ...
    public function analyzeFile()
    {
        ...
        try {
            ...
            $filename = uniqid('purchases_import_') . '.' . $extension; // Changed prefix
            ...
            // Skip resolution step for purchases, go directly to confirmation
            $this->step = 3; 
        ...
        <div class="bg-gradient-to-r from-orange-600 to-orange-800 rounded-xl shadow-2xl overflow-hidden -mx-6 sm:-mx-8">
            <div class="px-8 py-6">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-2xl font-bold text-white mb-1">Importacion de Compras</h1>
                        <p class="text-orange-100 text-sm">Carga masiva de materiales y proveedores</p>
                    </div>
        ...
        @if($step === 4)
            <div class="text-center space-y-6">
                ...
                <div class="flex justify-center space-x-4 mt-6">
                    ...
                    <a href="{{ route('app.purchases.index') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none">
                        Ver Historial
                    </a>
                </div>
            </div>
