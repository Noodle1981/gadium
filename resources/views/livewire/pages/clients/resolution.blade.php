...
<div class="py-6">
    <div class="mb-6">
        <h2 class="text-2xl font-bold text-gray-800 dark:text-white">Resolución de Clientes</h2>
        <p class="text-gray-600 dark:text-gray-400">Normalización inteligente de nombres de clientes</p>
    </div>
