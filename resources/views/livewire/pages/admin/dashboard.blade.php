        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="bg-white p-8 rounded-3xl border border-gray-200 shadow-sm transition-all hover:shadow-md group">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <a href="{{ route('users.index') }}" class="text-orange-600 font-bold text-sm flex items-center hover:underline">
                        Ver Lista
            ...
            <div class="bg-white p-8 rounded-3xl border border-gray-200 shadow-sm transition-all hover:shadow-md group">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <a href="{{ route('roles.index') }}" class="text-blue-600 font-bold text-sm flex items-center hover:underline">
                        Gestionar
                        <svg class="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                        </svg>
