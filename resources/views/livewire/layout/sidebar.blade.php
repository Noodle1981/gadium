...
<div x-data="{ open: false }" class="relative">
    ...
    <aside class="hidden lg:flex flex-col w-64 h-screen bg-gray-950 border-r border-gray-800 fixed left-0 top-0 z-40 transition-all duration-300">
        ...
        <div class="p-4 border-t border-gray-800">
            ...
            <!-- Profile Link -->
            <a href="{{ route('profile') }}" class="mt-4 w-full flex items-center justify-center px-4 py-2 text-xs font-semibold text-gray-500 hover:text-white hover:bg-gray-800 rounded-lg transition-colors duration-200" wire:navigate>
