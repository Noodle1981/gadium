...
class UserManagementTest extends TestCase
{
    ...
    public function test_admin_can_create_user(): void
    {
        ...
        $response->assertRedirect(route('app.users.index'));
    ...
    public function test_admin_can_update_user(): void
    {
        ...
        $response = $this->actingAs($admin)->put("/app/users/{$user->id}", [
            'name' => 'Updated Name',
            'email' => $user->email,
            'role' => 'Manager',
        ]);
    ...
    public function test_admin_can_delete_user(): void
    {
        ...
        $response = $this->actingAs($admin)->delete("/app/users/{$user->id}");
    ...
    public function test_super_admin_cannot_be_deleted(): void
    {
        ...
        $response = $this->actingAs($admin)->delete("/app/users/{$superAdmin->id}");
    ...
    public function test_viewer_cannot_access_users(): void
    {
        ...
        $response = $this->actingAs($viewer)->get('/app/users');
